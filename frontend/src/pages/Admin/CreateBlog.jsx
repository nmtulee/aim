...
import { useCreateBlogMutation } from '../../redux/api/blogApiSlice.js';
import {
...
const CreateBlog = () => {
  ...
  const [createBlog, { isLoading: blogLoading }] = useCreateBlogMutation();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Navigate to blogs or the created blog
      navigate('/blogs');
    } catch (err) {
      console.error(err);
      toast.error(err?.data?.message || err.error);
          ...
          <div className='p-8 md:p-12'>
            <form onSubmit={handleSubmit} className='space-y-8'>
              ...
              <div className='flex flex-col sm:flex-row gap-4 pt-6'>
                <Link
                  to='/blogs'
                  className='flex-1 bg-gray-200 hover:bg-gray-300 text-gray-700 px-8 py-4 rounded-2xl font-semibold transition-all duration-300 transform hover:scale-105 text-center'
                >
                  Cancel
                </Link>
                <button
