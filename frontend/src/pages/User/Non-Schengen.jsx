...
const NonSchengenJobsPage = () => {
  ...
  const countries = [
    {
      name: 'Albania',
      code: 'al',
      description: 'Growing tourism and construction sectors',
    },
    {
      name: 'Armenia',
      code: 'am',
    ...
    },
    {
      name: 'Azerbaijan',
      code: 'az',
      description: 'Oil, gas, and construction industries',
    },
    {
      name: 'Belarus',
      code: 'by',
      description: 'Manufacturing and agricultural sectors',
    },
    {
      name: 'Bosnia and Herzegovina',
      code: 'ba',
      description: 'Construction and service industries',
    },
    {
      name: 'Bulgaria',
      code: 'bg',
      description: 'Manufacturing and agriculture',
    },
    {
      name: 'Croatia',
      code: 'hr',
      description: 'Tourism, construction, and maritime',
    },
    {
      name: 'Cyprus',
      code: 'cy',
      description: 'Tourism, finance, and shipping',
    },
    {
      name: 'Georgia',
      code: 'ge',
      description: 'Tourism, agriculture, and wine industry',
    },
    {
      name: 'Hungary',
      code: 'hu',
    ...
    },
    {
      name: 'Kosovo',
      code: 'xk',
      description: 'Construction and service sectors',
    },
    { name: 'Malta', code: 'mt', description: 'Gaming, finance, and tourism' },
    {
      name: 'Moldova',
      code: 'md',
      description: 'Agriculture and textile industries',
    },
    {
      name: 'Montenegro',
      code: 'me',
      description: 'Tourism and energy sectors',
    },
    {
      name: 'North Macedonia',
      code: 'mk',
      description: 'Textile and food processing',
    },
    {
      name: 'Romania',
      code: 'ro',
      description: 'Construction, manufacturing, and agriculture',
    },
    {
      name: 'Russia',
      code: 'ru',
      description: 'Oil, gas, and heavy industries',
    },
    { name: 'Serbia', code: 'rs', description: 'Automotive and manufacturing' },
    { name: 'Ukraine', code: 'ua', description: 'Agriculture and IT services' },
    {
      name: 'Turkey',
      code: 'tr',
      description: 'Construction, textile, and tourism',
    },
    {
      name: 'UAE',
      code: 'ae',
  ...
  const sectors = [
    ...
    { name: 'Agriculture', icon: '🌾', demand: 'Medium' },
    { name: 'IT Services', icon: '💻', demand: 'High' },
  ];
      ...
      <section className='container mx-auto px-4 pt-20 pb-12'>
        ...
        >
          ...
          <p className='text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed'>
            Unlock your career potential with legal overseas employment
            opportunities in countries outside the Schengen zone. Start your
        ...
        <div className='flex flex-col lg:flex-row items-center gap-12 mb-16'>
          <div className='lg:w-1/2'>
            <div className='relative group'>
              <img
                src='/jobsearch.webp'
                alt='Non-Schengen Jobs - International Career Opportunities'
          ...
          <div className='lg:w-1/2'>
            ...
            <p className='text-gray-600 mb-8 text-lg leading-relaxed'>
              Non-Schengen countries offer diverse employment opportunities
              across multiple sectors. From Romania and Hungary to UAE and
              Cyprus, these destinations provide legal pathways for skilled,
              semi-skilled, and entry-level workers in construction, healthcare,
        ...
        <div className='grid lg:grid-cols-2 gap-8 mb-16'>
          ...
          <div className='bg-white/70 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-white/20'>
            ...
            <p className='text-gray-600 leading-relaxed mb-6'>
              With hundreds of successful placements and a 100% visa success
        ...
        <div className='mb-16'>
          ...
          <p className='text-center text-gray-600 mb-12 max-w-2xl mx-auto'>
            Explore job opportunities in these Non-Schengen countries with
            established employment programs
          </p>
        ...
        {/* Call to Action */}
        <div className='bg-gradient-to-r from-green-600 via-blue-600 to-purple-600 rounded-3xl p-12 text-center text-white shadow-2xl'>
          <div className='max-w-3xl mx-auto'>
            <h2 className='text-3xl md:text-4xl font-bold mb-6'>
              Ready to Start Your International Career?
            </h2>
            <p className='text-xl text-blue-100 mb-8 leading-relaxed'>
              Don't let borders limit your potential. Join thousands of
              successful candidates who have transformed their careers through
              our Non-Schengen job placement programs.
            </p>
        ...
        <div className='mt-16 grid grid-cols-2 md:grid-cols-4 gap-8'>
          ...
          <div className='text-center'>
            ...
            <div className='text-gray-600 font-medium'>Partner Countries</div>
          </div>
          <div className='text-center'>
...
export default NonSchengenJobsPage;
